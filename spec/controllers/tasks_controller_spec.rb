  ...
  describe "PUT update" do
   ...
   describe 'DELETE destroy' do
     it "destroys the requested task" do
       ...
       task = Task.should_receive(:find).with('10').and_return(mock_task)
      # Task.should_receive(:check_task_before_delete).with (mock_task.order_id).and_return(mock_task.order_id )
